...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII: 1 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\user-profiles](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\user-profiles)
...
graph LR
  ...
  user_profiles["user_profiles"]:::center
  user_profiles -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package user-profiles -Apply
