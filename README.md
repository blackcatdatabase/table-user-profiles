...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 1 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\user-profiles](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\user-profiles) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package user-profiles -Apply
