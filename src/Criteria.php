 ...
 * - whitelist filtrů: [ 'user_id', 'profile_enc', 'key_version', 'encryption_meta', 'updated_at', 'version' ]
 * - whitelist LIKE:   [ 'key_version' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'user_id', 'profile_enc', 'key_version', 'encryption_meta', 'updated_at', 'version' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'user_id', 'profile_enc', 'key_version', 'encryption_meta', 'updated_at', 'version' ], true);
            $parts = [];
