...
namespace BlackCat\Database\Packages\UserProfiles\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO UserProfileDto:
...
final class UserProfileDtoMapper
{
    ...
    /** @var string[] */
    private const DATE_COLS   = [ 'updated_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'profile_enc' ];
     ...
     */
    public static function fromRow(array $row): UserProfileDto
    {
        /** @var UserProfileDto */
    ...
    public static function fromRowOrNull(?array $row): ?UserProfileDto
    {
     ...
     */
    public static function toRow(UserProfileDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(UserProfileDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(UserProfileDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,UserProfileDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,UserProfileDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(UserProfileDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,UserProfileDto>
     */
