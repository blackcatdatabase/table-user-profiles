...
use BlackCat\Database\Packages\UserProfiles\Repository\UserProfileRepository as GeneratedRepository;
...
{
  private UserProfileRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof UserProfileRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected UserProfileRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\UserProfiles\Dto\UserProfileDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\UserProfiles\Dto\UserProfileDto|null { return $this->repo->getById($id, $asDto); }
