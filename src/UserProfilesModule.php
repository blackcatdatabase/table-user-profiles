...
final class UserProfilesModule implements ModuleInterface
{
    public function name(): string { return 'table-user_profiles'; }
    public function table(): string { return 'user_profiles'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedFk  = [ 'fk_user_profiles_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [],
            'foreignKeys' => [ 'fk_user_profiles_user' ],
        ];
    }
}
