...
final class UserProfileRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`user_profiles`' : '"user_profiles"';
     ...
     * [ 'user_id' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'profile_enc', 'key_version', 'encryption_meta', 'updated_at' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'user_id' ];
        $upd  = [ 'profile_enc', 'key_version', 'encryption_meta', 'updated_at' ];
